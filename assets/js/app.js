...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >Keep a single spark to start a prairie fire. <br/> 积蓄星火，以待磅礴。</p>
    </div>
        ...
        <div class="col-lg-5 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header">
                ...
                <form name="form1" action="https://formcarry.com/s/BydVpd9Td-E" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                  ...
                  <textarea id="textArea" type="message" name="message" placeholder="Type your Message 输入要发送的信息" required></textarea>
